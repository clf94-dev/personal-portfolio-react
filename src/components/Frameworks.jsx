...
function Frameworks(){
    return(
        <div className="frameworks-cont">
           ...
           <Link className="link" to='/portfolioreact'> <div className="react-cont" onClick="">
            ...
            <Link className="link" to='/portfolioangular'><div className="angular-cont">
            ...
            <Link className="link" to='/portfoliovue'><div className="vue-cont">
