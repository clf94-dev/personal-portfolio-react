...
function Frameworks(){
    return(
        <div className="frameworks-cont">
           ...
           <Link className="link" to='/portfolioreact'> <div className="react-cont" data-aos='fade-left' >
            ...
            <Link className="link" to='/portfolioangular'><div className="angular-cont" data-aos='fade-left' >
            ...
            <Link className="link" to='/portfoliovue'><div className="vue-cont" data-aos='fade-left' >
